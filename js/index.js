...
let hipodoge = new Mokepon('Hipodoge', '../assets/mokepons_mokepon_hipodoge_attack.webp', 5, '../assets/hipodoge.png', 100, 30)
let capipepo = new Mokepon('Capipepo', '../assets/mokepons_mokepon_capipepo_attack.webp', 5, '../assets/capipepo.png', 100, 30)
let ratigueya = new Mokepon('Ratigueya', '../assets/mokepons_mokepon_ratigueya_attack.webp', 5, '../assets/ratigueya.png', 100, 30)
...
function pintarCanvas() {
    ...
    mascotaJugadorObjeto.pintarMonkepon()

    enviarPosicion(mascotaJugadorObjeto.x, mascotaJugadorObjeto.y)


    hipodogeEnemigo.pintarMonkepon()
    ratigueyaEnemigo.pintarMonkepon()
    capipepoEnemigo.pintarMonkepon()
...
function iniciarMapa() {
    ...
    window.addEventListener('keydown', letraPrecionada);
